// TODO(paso 2 del refactor): estas funciones son reglas de negocio de "órdenes" y
// "actividades", no de conexión a la base. Cuando migremos routes/ordenes.js y
// routes/actividades.js al patrón routes/service/repository, esto se reparte entre
// modules/ordenes/ordenes.service.js y modules/actividades/actividades.service.js,
// y este archivo (y el require de compatibilidad en config/database.js) desaparece.
const { run, all, get } = require('./connection');

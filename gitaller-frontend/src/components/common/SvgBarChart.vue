  ...
  <div class="svg-bar-chart">
    <svg viewBox="0 0 500 250" preserveAspectRatio="xMidYMid meet">
      <g v-for="(item, i) in data" :key="i">
        <rect :x="i * barSpacing + offset" y="30" :width="barWidth" height="190" fill="var(--border-soft)" rx="4" />
...
<style scoped>
.svg-bar-chart { width: 100%; height: 250px; background: var(--surface); border-radius: var(--radius); padding: 10px; border: 1px solid var(--border-soft); overflow: hidden; box-sizing: border-box; }
